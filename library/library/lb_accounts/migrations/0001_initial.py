    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saved_events', models.ManyToManyField(blank=True, null=True, related_name='library_profile_saved_events', to='lb_events.event')),
                ('saved_items', models.ManyToManyField(blank=True, null=True, related_name='library_profile_saved_items', to='lb_collections.item')),
            ],
        ),
    ]
